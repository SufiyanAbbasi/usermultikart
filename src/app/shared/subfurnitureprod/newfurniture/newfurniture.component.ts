...
@Component({
  selector: 'app-newfurniture',
  standalone: true,
  imports: [CommonModule, FontAwesomeModule, RouterLink, RouterOutlet],
  templateUrl: './newfurniture.component.html',
  styleUrl: './newfurniture.component.css'
})
export class NewfurnitureComponent {
  star = faStar
  cart = faShoppingCart
